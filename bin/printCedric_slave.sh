...
base_dir=/users/cn/sjin/projects/homoplasy/nf_homoplasty
...
do
        ...
        for mode1 in ${flavour[@]} ## PROG - REG
        do
            [[ $mode1 == "reg_align" ]] && mode2="dpa_align"
                ...
                do
                        ...
                        do
                                ...
                                do
                                        ...
                                        ./individual_scores/${family}.${mode2}.${size}.${align_method}.${tree_method}.sp \
                                        ./individual_scores/${family}.${mode2}.${size}.${align_method}.${tree_method}.col \
                                        ./alignments/${family}.dpa_${size}.${align_method}.with.${tree_method}.tree.homo \
                                        ./alignments/${family}.dpa_${size}.${align_method}.with.${tree_method}.tree.w_homo \
                                        ./alignments/${family}.dpa_${size}.${align_method}.with.${tree_method}.tree.w_homo2 \
                                        ./alignments/${family}.dpa_${size}.${align_method}.with.${tree_method}.tree.len \
                                        ./alignments/${family}.dpa_${size}.${align_method}.with.${tree_method}.tree.ngap \
                                        ./alignments/${family}.dpa_${size}.${align_method}.with.${tree_method}.tree.ngap2 \
                                        | tr -d "l"| tr '\t' ';'| tr "\n" ";" | tr -d "[:space:]" | sed 's/.\{1\}$//'
                                        #| tr -d "l" | tr '\t' ';'| tr -d "[:space:]"     
                                        # cat ./individual_scores/${family}.${flavour}.${size}.${align_method}.with.${tree_method}.tree.tc \
                                        # ./homoplasy/${family}.${flavour}.${size}.${align_method}.with.${tree_method}.tree.homo \
                                        # ./homoplasy/${family}.${flavour}.${size}.${align_method}.with.${tree_method}.tree.w_homo \
                                        # ./homoplasy/${family}.${flavour}.${size}.${align_method}.with.${tree_method}.tree.w_homo2 \
                                        # ./homoplasy/${family}.${flavour}.${size}.${align_method}.with.${tree_method}.tree.len \
                                        # ./homoplasy/${family}.${flavour}.${size}.${align_method}.with.${tree_method}.tree.ngap \
                                        # ./homoplasy/${family}.${flavour}.${size}.${align_method}.with.${tree_method}.tree.ngap2 \
                                        else
