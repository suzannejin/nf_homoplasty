...
p_tree_gap_top20 <- ggplot(data = full_top20, aes(x = gap, y = tc, color = family, label = tree)) +
  geom_point() +
...
p_tree_hom_top20 <- ggplot(data = full_top20, aes(x = hom, y = tc, color = family, label = tree)) +
  geom_point() +
  geom_smooth(method = "lm", fill = NA)+
  geom_vline(xintercept = 0) + geom_hline(yintercept = 0)+
  ggtitle("top20") +
...
p_tree_w_hom_top20 <- ggplot(data = full_top20, aes(x = w_hom, y = tc, color = family, label = tree)) +
  geom_point() +
  geom_smooth(method = "lm", fill = NA)+
  geom_vline(xintercept = 0) + geom_hline(yintercept = 0)+
  ggtitle("top20") +
